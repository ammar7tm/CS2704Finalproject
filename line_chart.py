...
data = {
    ...
    '18-29': [70, 72, 76, 78, 77, 83, 86, 89, 89, 92, 92, 94, 96, 97, 97, 97, 99, 98.5, 98, 100, 99.5, 99],
...
line_fig = px.line(df_melted, x='Year', y='Internet_Usage', color='Age_Group', title='Internet Usage Over Time by Age Group')
line_fig.show()